...
export class ServicesController {
    ...
    static async getServicesByDepartment(req: Request, res: Response): Promise<void> {
        try {
            const services = await servicesService.getServicesByDepartment(Number(req.params.departmentId));
            res.status(200).json(services);
        } catch (error) {
