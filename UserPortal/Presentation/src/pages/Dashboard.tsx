...
const Dashboard = () => {
  ...
  const latestAppointment = bookedAppointments.find(apt => apt.status === "upcoming") || bookedAppointments[0];
                ...
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <p className="text-primary-foreground/90">
                      {latestAppointment.service?.department?.name}
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <p className="font-medium">
                      {new Date(latestAppointment.scheduledAt).toLocaleDateString()} at{" "}
                      {new Date(latestAppointment.scheduledAt).toLocaleTimeString()}
                    </p>
                  </div>
                  <div>
